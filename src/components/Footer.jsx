  ...
  return (
    <footer className="bg-brandGray/20 border-t border-gray-900 py-16 text-center space-y-6 mt-auto z-10">
      <div className="flex justify-center space-x-6 text-gray-500">
        <a href="https://www.instagram.com/thedrivetouringcompany?igsh=Y3NicDY0NTNqM29u" target="_blank" rel="noopener noreferrer" className="hover:text-brandTeal transition" aria-label="Instagram">
        ...
        {/*  </svg>*/}
        {/*</a>*/}
        <a href="mailto:info@thedrivetouringcompany.com" className="hover:text-brandTeal transition" aria-label="Email">
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
